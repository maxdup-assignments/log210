...
(function() {
  angular.module('restoApp', ['ngRoute', 'ngCookies', 'ngResource', 'resto.services', 'resto.userControllers', 'resto.restoControllers', 'resto.menuControllers', 'resto.commandeControllers', 'gettext']).config(function($routeProvider, $httpProvider) {
