...
(function() {
  angular.module('resto.userControllers', []).controller('RootController', function($scope, $location, $http, $route, Profile) {
    $scope.loginform = {
      'username': '',
      'password': ''
    };
  ...
  }).controller('UserController', function($scope, $location, $http, Profile) {
    var userform;
    userform = {
      'user': {
        'username': '',
