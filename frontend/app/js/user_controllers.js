...
(function() {
  angular.module('resto.userControllers', []).controller('RootController', function($scope, $location, $http, $route, $cookies) {
    $scope.auth = auth === 'True';
    $http.defaults.headers.post['X-CSRFToken'] = $cookies['csrftoken'];
    $http.get('http://127.0.0.1:8000/api/profile').success(function(data) {
    ...
    $scope.login = function() {
      return $http.post('http://127.0.0.1:8000/api/login', $scope.loginform).success(function(data) {
        $scope.auth = true;
    ...
    return $scope.logout = function() {
      return $http.get('http://127.0.0.1:8000/api/logout').success(function(data) {
        $scope.auth = false;
        $scope.profile = null;
